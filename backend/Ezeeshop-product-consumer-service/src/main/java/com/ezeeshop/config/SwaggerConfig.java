/*
 * package com.ezeeshop.config; import
 ...
 * basePackage("com.ezeeshop"))
 * .paths(PathSelectors.regex("/.*")).build().apiInfo(apiEndPointInfo()); }
 * 
 * private ApiInfo apiEndPointInfo() { // TODO Auto-generated method stub return
 * new ApiInfoBuilder().title("EzeeShop")
 * .description("EzeeShop Ecommerce Website") .contact(new
 * Contact("ShubhamSingh", "mycompany.com", "shubhamsingh397@gmail.com"))
 * .license("Apache 2.0")
